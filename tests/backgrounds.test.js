...
test("advanced background settings survive deck normalization", () => {
  const slide = createSlide({ backgroundType: "gradient", backgroundGradientStart: "#112233", backgroundGradientEnd: "#aabbcc", backgroundGradientAngle: 42, backgroundOverlayOpacity: 0.35, backgroundShader: "aurora" });
